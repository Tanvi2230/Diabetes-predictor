...
from src.utils import FEATURE_COLUMNS, PROJECT_ROOT
...
def create_visualizations(
    ...
    plt.close()
    generated_paths["correlation_heatmap"] = str(correlation_path.relative_to(PROJECT_ROOT))
    ...
    plt.close(figure)
    generated_paths["feature_distributions"] = str(distribution_path.relative_to(PROJECT_ROOT))
    ...
    plt.close()
    generated_paths["feature_importance"] = str(importance_path.relative_to(PROJECT_ROOT))
    ...
    plt.close()
    generated_paths["confusion_matrix"] = str(confusion_path.relative_to(PROJECT_ROOT))
